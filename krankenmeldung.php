...
<div class="container main-container">
	<h1>Krankenmeldung</h1>
	<p>über Verhinderung an der Teilnahme am Unterricht oder einer sonstigen verbindlichen Schulveranstaltung gemäß
§ 39 Abs. 1 RSO (z. B. Krankheit)</p>
			<?php 
...
<br>
	<br>
	<b>Schritt 1: </b><a href="javascript:self.print()">Speichern als PDF</a><br>
	<b>Schritt 2: </b><a href="abgabe.php">Abgabe</a>
	<script>
